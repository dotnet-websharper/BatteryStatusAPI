...
function Main(){
  ...
  const b=(this_1.h.push(new _c_7("batterystatus", batteryStatus().View)),this_1);
...
let _c_8=Lazy((_i) => class $StartupCode_Client {
  ...
  static {
    this.batteryStatus=_c_11.Create_1("Checking battery status...");
  }
});
function NewGuid(){
