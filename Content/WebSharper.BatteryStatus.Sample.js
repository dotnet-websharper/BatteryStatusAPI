...
{
 "use strict";
 var WebSharper,BatteryStatus,Sample,Client,Operators,Obj,UI,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,TemplateHole,Var,Unchecked,WebSharper$BatteryStatus$Sample_Templates,JavaScript,Pervasives,EventTarget,WindowOrWorkerGlobalScope,JS,TemplateHoleModule,Text,TextView,SC$1,System,Guid,Handler,Client$1,Templates,Doc,Node,Utils,Collections,Dictionary,Object,Var$1,HashSet,Seq,TemplateInitializer,VarStr,VarFloatUnchecked,VarBool,VarDateTime,VarFile,VarDomElement,View,Numeric,ConcreteVar,Snap,DictionaryUtil,Enumerator,T,SC$2,Docs,DocElemNode,CharacterData,Abbrev,Fresh,Blob,Elt,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,Elt$1,Attribute,Event,AttrModule,EventQ,AttrProxy,AfterRender,AfterRenderQ,List,T$1,Strings,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,HashSetUtil,SC$4,SC$5,SC$6,AppendList,DynamicAttrNode,Error,KeyNotFoundException,SC$7,Scheduler,Easing,AsyncBody,SC$8,CT,HashSet$1,BindVar,String,CheckedInput,CancellationTokenSource,DomNodes,Char,DateUtil,OperationCanceledException,Lazy,SC$9,Queue,LazyExtensionsProxy,LazyRecord,Math,Runtime$1,console,Date;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 BatteryStatus=WebSharper.BatteryStatus=WebSharper.BatteryStatus||{};
 Sample=BatteryStatus.Sample=BatteryStatus.Sample||{};
 ...
 WebSharper$BatteryStatus$Sample_Templates=Global.WebSharper$BatteryStatus$Sample_Templates=Global.WebSharper$BatteryStatus$Sample_Templates||{};
 ...
 SC$1=Global.StartupCode$WebSharper_BatteryStatus_Sample$Client=Global.StartupCode$WebSharper_BatteryStatus_Sample$Client||{};
 ...
 {
  var _,b,_this,p,i;
  Client.initializeBattery();
  _=(b=(_this=new ProviderBuilder.New$1(),(_this.h.push(new TextView.New("batterystatus",Client.batteryStatus().get_View())),_this)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],WebSharper$BatteryStatus$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
  Templates.LoadLocalTemplates("");
  Doc.RunById("main",_);
 };
 Client.initializeBattery=function()
 {
  try
  {
   self.navigator.getBattery().then(function(battery)
   {
    Client.updateBatteryInfo(battery);
    battery.addEventListener("levelchange",function()
    {
     return Client.updateBatteryInfo(battery);
    });
  ...
  {
   Client.batteryStatus().Set(Global.String(error.message));
  }
 };
 Client.batteryStatus=function()
 {
  SC$1.$cctor();
  return SC$1.batteryStatus;
 };
 Client.updateBatteryInfo=function(battery)
 {
  var batteryText;
  batteryText="Battery Level: "+Global.String(Operators.toInt(battery.level*100))+"%<br>Charging: "+Utils.toSafe(battery.charging?"Yes \u26a1":"No")+"<br>Time to Full Charge: "+Utils.toSafe(battery.chargingTime>0?battery.chargingTime.toFixed(6)+"s":"N/A")+"<br>Time to Empty: "+Utils.toSafe(battery.dischargingTime>0?battery.dischargingTime.toFixed(6)+"s":"N/A");
  self.document.getElementById("battery-status").innerHTML=batteryText;
 };
 ...
 WebSharper$BatteryStatus$Sample_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.batteryStatus=Var$1.Create$1("Checking battery status...");
 };
